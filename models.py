...
class Up(nn.Module):
    ...
    def forward(
        self, x1, x2
    ):  # x1: torch.Size([1, 1024, 16, 16]), x2: torch.Size([1, 512, 32, 32])
        x1 = self.up(x1)  # torch.Size([1, 512, 32, 32])
        # input is CHW
        ...
        x = torch.cat([x2, x1], dim=1)  # torch.Size([1, 1024, 32, 32])
        return self.conv(x)
...
class UNet(nn.Module):
    ...
    def forward(self, x):  # torch.Size([1, 3, 256, 256])
        x1 = self.inc(x)  # torch.Size([1, 64, 256, 256])
        x2 = self.down1(x1)  # torch.Size([1, 128, 128, 128])
        x3 = self.down2(x2)  # torch.Size([1, 256, 64, 64])
        x4 = self.down3(x3)  # torch.Size([1, 512, 32, 32])
        x5 = self.down4(x4)  # torch.Size([1, 1024, 16, 16])
        x = self.up1(x5, x4)  # torch.Size([1, 512, 32, 32])
        x = self.up2(x, x3)  # torch.Size([1, 256, 64, 64])
        x = self.up3(x, x2)  # torch.Size([1, 128, 128, 128])
        x = self.up4(x, x1)  # torch.Size([1, 64, 256, 256])
        logits = self.outc(x)  # torch.Size([1, 1, 256, 256])
        return logits
...
class RRCNN_block(nn.Module):
    ...
    def forward(self, x):
        x1 = self.Conv(x)  # torch.Size([1, 64, 256, 256])
        x2 = self.RCNN(x1)  # torch.Size([1, 64, 256, 256])
        out = x1 + x2  # torch.Size([1, 64, 256, 256])
        return out
...
class R2AttU_Net(nn.Module):
    ...
    def forward(self, x):  # torch.Size([1, 3, 256, 256])
        e1 = self.RRCNN1(x)  # torch.Size([1, 64, 256, 256])
...
if __name__ == "__main__":
    ...
    # model = R2AttU_Net(in_ch=3, out_ch=1)
